...
searchBtn.addEventListener('click', async () => {
  ...
  const data = await searchService.parkingLot({ numberOfResults: 50, filters: { bound: { right: bound._ne.lng, top: bound._ne.lat, left: bound._sw.lng, bottom: bound._sw.lat } } })
