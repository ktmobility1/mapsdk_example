...
const termsInput = document.getElementById('terms-input'); //사용자가 입력하는 input
const resultDiv = document.getElementById('result'); // 결과 div
const resultList = document.getElementById('result_list'); // 자동완성 결과 list

termsInput.addEventListener('keyup', async (e) => {
    ...
    let result = await searchService.autocomplete({ terms: value, type: 'POI' }); // type을 'POI'로 지정해야 좌표값을 받을 수 있습니다.
